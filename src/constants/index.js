...
export const EXPERIENCES = [
  {
    ...
    description: [
      "Developed a Django and GraphQL backend supporting 1,000+ participants with event registration, user authentication, and real-time schedule updates for one of Toronto's largest hackathons.",
      "Improved frontend performance by optimizing React component rendering and state management, reducing page load times by 50% and improving responsiveness during peak event traffic.",
      "Redesigned the signup and login experience with a mobile-first responsive UI, improving usability and reducing registration drop-off during mobile onboarding, increasing mobile form completion by 40%.",
    ],
    image: hack,
  },
  {
    ...
    description: [
      "Developed full-stack application features using Node.js, TypeScript, and Angular to support secure patient data exchange across distributed healthcare systems using HL7 FHIR standards.",
      "Increased Jest unit and integration test coverage from 50% to 65%, helping catch regressions earlier and improving release confidence across APIs and frontend components.",
      "Refactored 10+ REST APIs by adding input validation and standardized error handling, improving reliability and reducing failed patient data exchanges.",
    ],
    image: smile,
  },
  {
    ...
    description: [
      "Refactored 15+ Angular components to remove duplicated logic across shared modules, reducing shared module size by 40% and simplifying future frontend development.",
      "Developed and integrated 10+ RESTful APIs using ASP.NET Core and MongoDB, replacing direct cross-service database calls and reducing backend latency by 25%.",
      "Set up OpenTelemetry + Datadog observability across services, tracking 50+ metrics and cutting incident resolution time by 50%.",
    ],
    image: quest,
  },
  {
    ...
    company: "ML Analytix",
    description: [
      "Built React dashboards with real-time data visualizations to monitor warehouse inventory and computer vision outputs, improving operational visibility for daily production workflows.",
      "Developed Django REST API endpoints and optimized MySQL queries to automate multi-source data retrieval, replacing manual exports and saving hours of weekly reporting time.",
      "Added dynamic filtering and drill-down functionality to analytics dashboards, reducing time spent navigating data for analysis and improving reporting efficiency.",
    ],
    image: ml,
  },
];
